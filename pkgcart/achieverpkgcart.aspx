              							...
              							<tr>
                							<td width="290">Cap/Gown Color*: 
                                                <asp:CustomValidator ID="CustomValidator6" runat="server" 
                                                    ...
                                                    Display="Dynamic" ValidationGroup="g1" Enabled="False"></asp:CustomValidator>
                                            </td>
                							<td width="90" class="floatleft">
                                                <asp:DropDownList  runat="server" Height="22px" 
                                                    ...
                                                    causesvalidation="True" AutoPostBack="True" ValidationGroup="g1"> </asp:DropDownList>
                  	<script>
                      function change3(x) {
       ...
       <img src="../images/diplomasandcertificates/diplomas/diplomas_NEW/SmartStarts_General.jpg" width="37" height="29" alt="SmartStarts_General" id="104" onclick="changevalue1(this);"/></a>
  										...
  										<tr>
    										...
    										<td class="floatleft"><asp:DropDownList  runat="server" Height="25px" Width="196px" 
                                                    onchange="change(this);" ID="ddlcert" datasourceid="dscertificate" 
