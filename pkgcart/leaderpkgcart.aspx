<%@ Page Title="" Language="VB"  AutoEventWireup="false" CodeFile="leaderpkgcart.aspx.vb" Inherits="leaderpkgcart" %>
...
<table align="left" cellpadding="0" cellspacing="0" style="width: 673px; height: auto; margin-right: 0px;">
	<tr>
		...
		<a href="../shopjostenshome.aspx">Home</a> &gt; <a href="../packages.aspx">Packages</a><br /><strong><span class="style15">Leader Package<br /><br /></span></strong></td>
		<td></td>
	</tr>
	<tr>
		<td class="style25" valign="top"><img src="../images/package/leaderpackage_2.jpg" alt="Leader Package" name="theImg5"  id="theImg5" onmouseover="MM_swapImgRestore()"   />&nbsp;&nbsp;<asp:Label ID="lblprodcode" runat="server" ForeColor="#D74141" Text="06KLEADPKD" Visible="False"></asp:Label>
        </td>
		
        <td valign="top">
			<div id="packprice"> 
				<strong>Our Price: <span class="red">$</span><asp:Label ID="LBLPKG" runat="server" ForeColor="#D74141" Text="06KLEADPKD"></asp:Label><br /></strong><br /><font color="#0000CC"><em>Note:</em> Cap and Gown in packages will be the same color.</font><br /><font>&nbsp;<br />
			...
			<div id="select_options">
              ...
              <img src="../images/package/caps_gowns/kk_gown_black.jpg" width="25" height="50" 
                  ...
                  <img src="../images/package/caps_gowns/kk_regalia_white.jpg" width="25" height="50" alt="kk_regalia_white.jpg" id="173" onclick="changevalue3(this);" /></a>
              							...
              							<tr>
                <td width="290" class="style32">Cap/Gown Color*: 
                    <asp:CustomValidator ID="CustomValidator6" runat="server" 
                        ErrorMessage="Color Out Of Stock" ValidationGroup="g1" Enabled="False"></asp:CustomValidator>
                                            </td>
                <td width="90" class="floatleft">
                    <asp:DropDownList  runat="server" Height="20px" Width="116px" 
								onchange="change3(this);" datasourceid="dscapclr" 
								DataTextField="optiondesc" DataValueField="id" ID="ddlclr" causesvalidation="True" ValidationGroup="g1"> </asp:DropDownList>
                  <script>
                      function change3(x) {
