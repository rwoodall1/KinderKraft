...
<asp:SqlDataSource ID="dscolor" runat="server" 
                ...
                SelectCommand="SELECT id, optiondesc, selectorder FROM options WHERE (optioncatid = 50) ORDER BY selectorder, optiondesc">
			</asp:SqlDataSource>
</div>
...
<div id="content">
	<table cellpadding="0" cellspacing="0" style="width: 660px; height: auto">
		<tr>
			...
			<strong><span class="style15">Banner<br /><br /></span></strong>
           	</td>
			<td></td>
		</tr>
		<tr>
			<td rowspan="2" valign="top">
			<img src="../images/banners/KK2015Grad36inch.jpg"  name="defaultBanner" id="defaultBanner" />
			</td>
			<td height="79" valign="top">
				<div id="packprice" style="height:auto"> 
                    ...
                    <br /><br /></font></strong>Congratulations is in order for your little graduate, so shout it out with a custom banner. Complete the information below and submit a high resolution picture of your graduate to create your own custom banner.
     	...
     	<tr>
        	<td height="202" valign="top" style="height:auto">
            	<div id="select_options">
                    ...
                    <p style="margin-left:10px" class="field_label"><label>First Name: </label>
                        <asp:TextBox ID="txtfname" runat="server" style="margin-bottom: 0px" Width="248px"></asp:TextBox>
                        <br /><em> <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="First Name Required" ControlToValidate="txtfname" ForeColor="Red" Display="Dynamic" ValidationGroup="v1"></asp:RequiredFieldValidator></em>
                    </p>
               	  	<p style="margin-left:10px" class="field_label"><label>Last Name: </label>
                        <asp:TextBox ID="txtlname" runat="server" Width="248px"></asp:TextBox>
                              <br /><em> <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ErrorMessage="Last Name Required" ControlToValidate="txtlname" ForeColor="Red" Display="Dynamic" ValidationGroup="v1"></asp:RequiredFieldValidator>
                        
                        </em>
                    </p>
                                        
                    <p style="margin-left:10px" class="field_label">Please Select Color:&nbsp;
                        <asp:DropDownList ID="ddlclr" runat="server" Height="22px" Width="147px" onchange="change(this);" DataSourceID="dscolor" DataTextField="optiondesc" DataValueField="id">
                        </asp:DropDownList><br /><asp:CustomValidator ID="CustomValidator2" runat="server" ErrorMessage="CustomValidator" ForeColor="Red" ValidationGroup="v1"></asp:CustomValidator>
                   </p>
                   <script type="text/javascript">
                            				function change(x) 
											{
                    ...
                    <script type="text/javascript">
                        var img3 =
                            ["../images/banners/KK2015Grad36inch.jpg", "../images/banners/KK2015Grad36inch_blue.jpg", "../images/banners/KK2015Grad36inch_green.jpg", "../images/banners/KK2015Grad36inch_orange.jpg", "../images/banners/KK2015Grad36inch_pink.jpg", "../images/banners/KK2015Grad36inch_purple.jpg", "../images/banners/KK2015Grad36inch_red.jpg", "../images/banners/KK2015Grad36inch_yellow.jpg"];
                                     </script>
                   
                       <div style="margin-left:10px">
                            <a href="javascript:;" onclick="MM_swapImage('defaultBanner','','../images/banners/KK2015Grad36inch_blue.jpg',1)">
                                <img src="../images/banners/blue.jpg" alt="" width="40" height="40" id="263" onclick="changevalue(this);" border="0"/></a>
                            <a href="javascript:;" onclick="MM_swapImage('defaultBanner','','../images/banners/KK2015Grad36inch_green.jpg',1)">
                                <img src="../images/banners/green.jpg" alt="" width="40" height="40" id="264" onclick="changevalue(this);" border="0"/></a>
                            <a href="javascript:;" onclick="MM_swapImage('defaultBanner','','../images/banners/KK2015Grad36inch_orange.jpg',1)">
                                <img src="../images/banners/orange.jpg" alt="" width="40" height="40" id="265" onclick="changevalue(this);" border="0"/></a>
                            <a href="javascript:;" onclick="MM_swapImage('defaultBanner','','../images/banners/KK2015Grad36inch_pink.jpg',1)">
                                <img src="../images/banners/pink.jpg" alt="" width="40" height="40" id="266" onclick="changevalue(this);" border="0"/></a>
                            <a href="javascript:;" onclick="MM_swapImage('defaultBanner','','../images/banners/KK2015Grad36inch_purple.jpg',1)">
                                <img src="../images/banners/purple.jpg" alt="" width="40" height="40" id="267" onclick="changevalue(this);" border="0"/></a>
                            <a href="javascript:;" onclick="MM_swapImage('defaultBanner','','../images/banners/KK2015Grad36inch_red.jpg',1)">
                                <img src="../images/banners/red.jpg" alt="" width="40" height="40"id="268" onclick="changevalue(this);" border="0"/></a>
                            <a href="javascript:;" onclick="MM_swapImage('defaultBanner','','../images/banners/KK2015Grad36inch_yellow.jpg',1)">
                                <img src="../images/banners/yellow.jpg" alt="" width="40" height="40" id="269" onclick="changevalue(this);" border="0"/></a>
                       </div>
                       <p style="margin-left:10px" class="field_label"><label>Upload Your Image: 
                           ...
                           </label>&nbsp;<table width="400">
                       	<tr>
					  			<td colspan="2">Qty: <asp:TextBox ID="txtqty" runat="server" Width="36px">1</asp:TextBox> &nbsp;&nbsp;&nbsp; 
                                    <asp:Button ID="btnadd" runat="server" Text="Add to Cart" ValidationGroup="v1" />
                                    <em> <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage="Enter quantity" ControlToValidate="txtqty" ForeColor="Red" ValidationGroup="v1"></asp:RequiredFieldValidator></em>
                                </td>
					  </tr>
				  </table>
