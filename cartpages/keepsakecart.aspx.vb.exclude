...
Partial Class keepsakecart
    ...
    Protected Sub Button1_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Button1.Click
        If Page.IsValid Then
            ...
            Dim detid As String = SC.AddToCart(SC.orderdetail, KMF.ID, Me.txtqty.Text, Me.KMF.Text, "Magnetic Keepsake Frame", ddlclr.SelectedItem.Text)

            Dim arroptions(0, 4) As String
            arroptions(0, 1) = Me.ddlclr.SelectedValue
            arroptions(0, 2) = Me.ddlclr.SelectedItem.Text
            arroptions(0, 3) = KMF.ID
    ...
    Protected Sub CustomValidator2_ServerValidate(ByVal source As Object, ByVal args As System.Web.UI.WebControls.ServerValidateEventArgs) Handles CustomValidator2.ServerValidate
        ...
        If Trim(Me.ddlclr.SelectedItem.Text) = "Please Select" Then
            Me.CustomValidator2.ErrorMessage = "Please select a frame."
            retval = False
    ...
    Protected Sub KSASH_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles KMF.Load
