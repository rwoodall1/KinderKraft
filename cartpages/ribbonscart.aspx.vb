...
Partial Class ribbonscart
    ...
    Protected Sub Button1_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Button1.Click
        If Page.IsValid Then
            ...
            Dim detid As String = SC.AddToCart(SC.orderdetail, KRIBBON10PK.ID, Me.txtqty.Text, Me.KRIBBON10PK.Text, "Achievement Ribbon", ddlclr1.SelectedItem.Text)

            Dim arroptions(0, 4) As String
            arroptions(0, 1) = Me.ddlclr1.SelectedValue
            arroptions(0, 2) = Me.ddlclr1.SelectedItem.Text
            arroptions(0, 3) = KRIBBON10PK.ID
    ...
    Protected Sub LBLKRIBBON_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles KRIBBON10PK.Load
    ...
    Protected Sub CustomValidator2_ServerValidate(ByVal source As Object, ByVal args As System.Web.UI.WebControls.ServerValidateEventArgs) Handles CustomValidator2.ServerValidate
        ...
        If Trim(Me.ddlclr1.SelectedItem.Text) = "Please Select" Then
            Me.CustomValidator2.ErrorMessage = "Please select a ribbon option."
            retval = False
