...
Imports System.IO
Partial Class cartpages_diplomaframecart
	...
	Protected Sub Button1_Click(sender As Object, e As System.EventArgs) Handles Button1.Click
		If Page.IsValid Then
			...
			Dim detid As String = SC.AddToCart(SC.orderdetail, KDIPF.ID, Me.txtqty.Text, Me.KDIPF.Text, "Dipoma Frame", "")

			Dim arroptions(0, 4) As String
			arroptions(0, 1) = Me.ddlclr.SelectedValue
			arroptions(0, 2) = Me.ddlclr.SelectedItem.Text
			arroptions(0, 3) = KDIPF.ID
