...
Partial Class csashescart
    ...
    Protected Sub Button1_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Button1.Click
        If Page.IsValid Then
            ...
            Dim detid As String = SC.AddToCart(SC.orderdetail, KCHOIRSASH.ID, Me.txtqty.Text, Me.KCHOIRSASH.Text, "Choir Sashes", "")
            'no options to add on this product
